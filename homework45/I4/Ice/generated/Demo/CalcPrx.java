...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        setPrecision(precision, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setPrecision(int precision, java.util.Map<String, String> context)
    {
        _iceI_setPrecisionAsync(precision, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setPrecisionAsync(int precision)
    {
        return _iceI_setPrecisionAsync(precision, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setPrecisionAsync(int precision, java.util.Map<String, String> context)
    {
        return _iceI_setPrecisionAsync(precision, context, false);
    }

    /**
     * @hidden
     * @param iceP_precision -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setPrecisionAsync(int iceP_precision, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setPrecision", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeInt(iceP_precision);
                 }, null);
        return f;
    }

    default float avg(float[] numbers, boolean geometric)
    {
        return avg(numbers, geometric, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(float[] numbers, boolean geometric, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(numbers, geometric, context, true).waitForResponse();
    }

    default float avg(float[] numbers, java.util.Optional<java.lang.Boolean> geometric)
    {
        return avg(numbers, geometric, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(float[] numbers, java.util.Optional<java.lang.Boolean> geometric, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(numbers, geometric, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(float[] numbers, boolean geometric)
    {
        return _iceI_avgAsync(numbers, geometric, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(float[] numbers, boolean geometric, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(numbers, geometric, context, false);
    }

    /**
     * @hidden
     * @param iceP_numbers -
     * @param iceP_geometric -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(float[] iceP_numbers, boolean iceP_geometric, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloatSeq(iceP_numbers);
                     ostr.writeBool(1, iceP_geometric);
                 }, istr -> {
                     float ret;
                     ret = istr.readFloat();
                     return ret;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(float[] numbers, java.util.Optional<java.lang.Boolean> geometric)
    {
        return _iceI_avgAsync(numbers, geometric, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(float[] numbers, java.util.Optional<java.lang.Boolean> geometric, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(numbers, geometric, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(float[] iceP_numbers, java.util.Optional<java.lang.Boolean> iceP_geometric, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloatSeq(iceP_numbers);
